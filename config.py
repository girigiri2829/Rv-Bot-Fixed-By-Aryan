...
class Config(object):
    ...
    #tg bot token
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7129691556:AAGqbgGq01l6Sz9xGLmnIuarezCoN7rthUg")
    ...
    OWNER_ID = [int(i) for i in  os.environ.get("OWNER_ID", "2135601715").split(" ")]
    #log channel, where to send logs
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002097806846"))
    ...
    END_NAME = os.environ.get("END_NAME", "Gi Cartoons Network")
    METADATA_NAME = os.environ.get("METADATA_NAME", "Gi Cartoons Network")
